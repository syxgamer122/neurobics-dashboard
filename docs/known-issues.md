...
| KI-9 | P1 | Fixed in Phase 8 | Admin Reset vẫn tự hoàn nguyên. Đã thêm stats_epoch để chống reset hoàn nguyên. | feature_admin.txt |
...
| KI-20 | P4 | Open | Backup RPO/RTO chưa được test drill thực tế. | runbook.md |
