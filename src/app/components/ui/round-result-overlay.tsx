...
export function RoundResultOverlay({
  ...
  const showConfetti = result.headline >= RATING_MAX * 0.7;

  return (
    <>
      {showConfetti && <ConfettiCanvas accent={accent} />}
      <div
        className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-3 sm:p-4 animate-[fadeIn_0.25s_ease-out]"
        style={{
      ...
      >
        <div
          className="relative w-full max-w-sm rounded-2xl flex flex-col overflow-hidden animate-[slideUp_0.3s_cubic-bezier(0.34,1.56,0.64,1)]"
          style={{
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-5 sm:p-6 flex flex-col gap-4 sm:gap-5">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <span
                  className="text-4xl font-bold tabular-nums font-mono animate-[scorePop_0.5s_cubic-bezier(0.34,1.56,0.64,1)]"
                  style={{ color: accent }}
                >
                  {result.headline}
                </span>
