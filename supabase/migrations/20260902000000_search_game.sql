-- Migration cho game Visual Search

-- 1. Cap nhat profiles
alter table public.profiles add column if not exists search_sessions integer not null default 0;

-- 2. Cap nhat rang buoc cho bang training_sessions, round_tickets, xp_events
